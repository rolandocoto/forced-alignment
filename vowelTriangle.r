...
# Symbol that the resultsFile uses to mark decimals
# (Arabic and Spanish Windows use commas; Hindi and English Windows use dots)
decimalMarker = "."

# Read the file
inputSounds = read.table("C:\\Users\\Bender\\Desktop\\workshop\\resultsfile.txt", sep="\t", dec=decimalMarker, row.names=NULL, header=TRUE)
